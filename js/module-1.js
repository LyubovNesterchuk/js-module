...
// const messageAge = "Poly is " + age + " years old!";
...
// const produc = "Repair droid";
// console.log(produc[0]); // 'R'
// console.log(produc[5]); // 'r'
// console.log(produc[11]); // 'd'

// const lastElementIndex = produc.length - 1;
// console.log(produc[lastElementIndex]); // 'd'

// console.log(produc[produc.length - 1]); // 'd'
